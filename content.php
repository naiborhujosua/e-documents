...
<html>
<head>
  <title>Dashboard - Application of Managing Bussiness Trip Documents</title>
...
<body>
        ...
        <div class="profile-hidder">
            <ul class="nav">
                    <li class="nav-profile">
                        <div class="image">
                            <a href="javascript:;"><img src="images/user_2.jpg" alt=""></a>
                        </div>
                        <div class="info">
                             <!-- use session for namalengkap -->
                            <a href=""><?php echo $_SESSION[namalengkap]; ?> <b class="caret"></b></a>
                        </div>
                    </li>
            </ul>
        </div>
        <!-- call menu.php for menu -->
    ...
    <div class="content">
        ...
        <?php
            if ($_GET[view]=='home' OR $_GET[view]==''){
                ...
                include "master_data/pejabat.php";
    ...
    <!--implementation for animation by Jquery -->
